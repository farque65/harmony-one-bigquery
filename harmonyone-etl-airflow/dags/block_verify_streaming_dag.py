...
from harmonyoneetl.build_verify_streaming_dag import build_verify_streaming_dag
from harmonyoneetl.variables import read_verify_streaming_dag_vars
...
DAG = build_verify_streaming_dag(
    dag_id='harmonyone_verify_streaming_dag',
    chain='harmonyone',
    **read_verify_streaming_dag_vars(
        var_prefix='harmonyone_',
        max_lag_in_minutes=130,
    )
)
